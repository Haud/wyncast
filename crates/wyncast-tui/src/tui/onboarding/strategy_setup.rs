...
// Re-export shared types from wyncast-app so existing code can use the
// canonical path (crate::tui::onboarding::strategy_setup::CategoryWeights etc.)
pub use wyncast_app::onboarding::strategy_config::{
    categories_from_league, default_categories, mask_api_key, CategoryWeights, WEIGHT_COLS,
};
