// Unsaved changes confirmation overlay widget.
//
// Renders a centered modal dialog asking the user whether to save or discard
// unsaved settings changes. Displayed on top of the settings screen when
// `ViewState::confirm_exit_settings` is true.
...
/// Render the unsaved changes confirmation overlay centered on the screen.
